...
**Hardwicke** - *Illustrations of Indian Zoology* by **John Edward Gray** and **Thomas Hardwicke** (1830-1835), lithographs by **Benjamin Waterhouse Hawkins**, from the Commons category [Illustrations of Indian Zoology](https://commons.wikimedia.org/wiki/Category:Illustrations_of_Indian_Zoology). Public domain (PD-scan / PD-old-100). Manifest key: `hardwicke`.

**Naumann (Deutschlands)** - *Naturgeschichte der Vögel Deutschlands* by **Johann Andreas Naumann**, continued by his son **Johann Friedrich Naumann** (1820-1844), hand-coloured engravings after **Friedrich Sturm**, Biodiversity Heritage Library scans from the Commons category [Naturgeschichte der Vögel Deutschlands](https://commons.wikimedia.org/wiki/Category:Naturgeschichte_der_V%C3%B6gel_Deutschlands). Public domain (PD-scan / PD-old-100). The father's own folio, a separate work from the Hennicke revision above. Manifest key: `naumann-deutschlands`.

**Temminck** - *Nouveau recueil de planches coloriées d'oiseaux* by **Coenraad Jacob Temminck** and **Meiffren Laugier de Chartrouse** (1820-1839), plates by **Nicolas Huet le Jeune** and **Jean-Gabriel Prêtre**, Internet Archive scans from the Commons category [Nouveau recueil de planches coloriées d'oiseaux](https://commons.wikimedia.org/wiki/Category:Nouveau_recueil_de_planches_color%C3%A9es_d%27oiseaux). Public domain (PD-scan / PD-old-100). Manifest key: `temminck`.

**Iconographia Zoologica** - the print album assembled at the **University of Amsterdam**, holding plates cut from other works - among them **François-Nicolas Martinet**, **Paul Louis Oudart** after **Vieillot** and **François Levaillant** - digitised by the university's Special Collections and uploaded from the Commons category [Iconographia Zoologica](https://commons.wikimedia.org/wiki/Category:Iconographia_Zoologica). Public domain (PD-scan / PD-old-100). Manifest key: `iconographia`.

**Rijksmuseum** - drawings and watercolours from the **Rijksmuseum**'s own digitisation, released through [Rijksstudio](https://www.rijksmuseum.nl/en/rijksstudio). CC0. Manifest key: `rijksmuseum`.
