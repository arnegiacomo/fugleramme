"""Make the paper background of each plate transparent, drop the species-name
caption, and keep the illustration (bird, branch, leaves, rock, water scene)
plus the artist signature, with a small buffer of the original image around the
subject.
